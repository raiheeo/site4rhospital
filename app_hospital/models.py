...
class DoctorProfile(UserProfile):
    ...
    doctor_bio = models.TextField(null=True, blank=True)
...
class PatientProfile(models.Model):
    ...
    emergency_contact = PhoneNumberField(default= '+7', max_length=32)
...
class Appointment(models.Model):
    ...
    status = models.CharField(choices=APPOINTMENT_STATUS, max_length=32)
...
class MedicalAdvice(models.Model):
    ...
    medication = models.CharField(max_length=256)
...
class Feedback(models.Model):
    ...
    def clean(self):
        ...
        if not self.rating and not self.comment:
            raise ValidationError('Please could you rate our job')
